...
def main() -> int:
    ...
    if mode == "fixture":
        ...
        check(st == 200 and b"<h2>Editions</h2>" in av_body, "movie item lists editions")
        ...
        if odd:
            ...
            check(st == 200 and b'class="capability"' in body, "mkv play capability warning")
        ...
        check(b"#persist" in body and b"play-now" in body, "enhance persist player + play-now")
        ...
        check(b'data-hero="orisha.hero"' in body or b"Recently added" in body, "home has hero or recent shelf")
        ...
        check(b"Hydrate is flagged" in body or b"flagged" in body, "hydrate is flagged for the next idle request")
